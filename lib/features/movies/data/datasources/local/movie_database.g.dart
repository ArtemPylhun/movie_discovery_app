...
class $SearchCacheTable extends SearchCache
  ...
  late final GeneratedColumn<DateTime> cachedAt = GeneratedColumn<DateTime>(
      ...
      defaultValue: currentDateAndTime);
  @override
  List<GeneratedColumn> get $columns => [query, results, cachedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class SearchCacheData extends DataClass implements Insertable<SearchCacheData> {
  ...
  const SearchCacheData(
      {required this.query, required this.results, required this.cachedAt});
  @override
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
  ...
  SearchCacheData copyWith(
          {String? query, String? results, DateTime? cachedAt}) =>
      SearchCacheData(
  ...
  @override
  int get hashCode => Object.hash(query, results, cachedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
abstract class _$MovieDatabase extends GeneratedDatabase {
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities =>
      [movies, favorites, genres, searchCache];
}
...
class $$GenresTableFilterComposer
    extends Composer<_$MovieDatabase, $GenresTable> {
...
class $$GenresTableTableManager extends RootTableManager<
    ...
    (Genre, BaseReferences<_$MovieDatabase, $GenresTable, Genre>),
    Genre,
    PrefetchHooks Function()> {
  $$GenresTableTableManager(_$MovieDatabase db, $GenresTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
...
class $$SearchCacheTableFilterComposer
    extends Composer<_$MovieDatabase, $SearchCacheTable> {
...
class $$SearchCacheTableTableManager extends RootTableManager<
    ...
    (
      SearchCacheData,
      BaseReferences<_$MovieDatabase, $SearchCacheTable, SearchCacheData>
    ),
    SearchCacheData,
    PrefetchHooks Function()> {
  $$SearchCacheTableTableManager(_$MovieDatabase db, $SearchCacheTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
